...
"" ""
PENS
"Total" 1.0 0 -13421773 true "" "plot total-active-participants"
"Refugees" 1.0 0 -1554347 true "" "plot total-refugees-active"
"Locals" 1.0 0 -13728085 true "" "plot total-locals-active"
...
"" ""
PENS
"Avg Motivation" 1.0 0 -891879 true "" "plot avg-motivation-level"
...
"" ""
PENS
"Avg CEFR" 1.0 0 -6145166 true "" "plot avg-language-proficiency"
"A2 Target" 1.0 0 -7829368 true "" "plot 2.0"
...
"" ""
PENS
"Tie Ratio" 1.0 0 -12272732 true "" "plot cross-group-tie-ratio"
"Target (0.4)" 1.0 0 -7829368 true "" "plot 0.4"
...
"" ""
PENS
"Dropouts" 1.0 0 -6610123 true "" "plot total-dropouts"
...
"" ""
PENS
"Female %" 1.0 0 -1554347 true "" "plot female-participation-rate"
"Male %" 1.0 0 -13728085 true "" "plot male-participation-rate"
...
983
566
Agent-Based Modelling of Migrant Integration Through Community Sport
11
5.0
1
...
983
583
Abdullah Tadmuri    ·    Universidad Carlos III de Madrid    ·    MSc Computational Social Science
11
5.0
1
...
983
601
52 weeks   ·   5 parks   ·   75 migrants, 25 locals, 5 trainers   ·   calibrated to Istanbul (2013-2022)
10
4.0
1
...
983
709
brighter person colour   =   higher motivation
11
5.0
1
...
983
749
bold orange link   =   cross-group tie  (integration)
11
25.0
1
...
983
765
faint grey link   =   within-group tie
11
5.0
1
...
983
805
faint colour tint   =   each park's catchment area
11
5.0
1
...
983
844
grey person   =   dropped out (left the programme)
11
5.0
1
...
983
860
orange person   =   paused for winter
11
25.0
1
...
983
884
Note: each scenario sets its own parameters at setup;
10
4.0
1
...
983
900
sliders show the calibration baseline (BehaviorSpace locks all params for reproducible runs).
10
4.0
1
...
1555
759
active beta (peer-influence)
param-peer-influence-coef
3
1
11
...
807
locals / park (now)
count locals with [not has-dropped-out?] / num-parks
2
1
11
...
The interface is organised into three zones:
- **Left - controls**, grouped into SETUP & RUN, POPULATION, BEHAVIOURAL CALIBRATION, and ADVANCED / EXPERIMENTAL.
- **Centre - the world view** (with a colour legend beneath it).
- **Right - results**: the six time-series plots and a LIVE OUTCOMES monitor dashboard.

World legend:
- **red person = migrant**, **blue person = local** (brighter shade = higher motivation; agents stay within their colour so the group is always identifiable).
- **gold star = trainer** (offset beside its park so it is not hidden), **green tree = park** (canopy brightens with weekly attendance).
- **bold orange link = cross-group (migrant-local) tie** - the integration signal; **faint grey link = within-group tie**.
- **grey person = dropped out**; **orange person = paused for winter**; **faint background tint = each park's catchment area**.
